...
async fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    for metadata in mapping.metadata {
        info!("{} {} {}", metadata.lineup, metadata.modified, metadata.modified);
    }
    */
